...
static char *cpu_sensors_msm8937[] =
{
    "tsens_tz_sensor5",
    "tsens_tz_sensor6",
    "tsens_tz_sensor7",
...
static char *misc_sensors_msm8937[] =
{
    "tsens_tz_sensor10"
};

static struct target_therm_cfg sensor_cfg_msm8937[] = {
    {
...
ssize_t get_temperatures(thermal_module_t *module, temperature_t *list, size_t size) {
	...
	thermal_sens_size = thermal_zone_init(sensor_cfg_msm8937,
                                ARRAY_SIZE(sensor_cfg_msm8937));
